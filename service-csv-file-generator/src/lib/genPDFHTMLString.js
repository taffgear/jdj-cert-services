    ...
    <div class="bg" style="position:absolute;left:50%;margin-left:-309px;top:0px;width:620px;height:877px;overflow:hidden;">
      <table style="width: 100%;">
		...
		`</td>
                    ...
                    <tr>
                      <td class="cls_005">` +
		obj.customerAddress1.value +
		` ` +
		obj.customerAddress2.value +
		`</td>
                    </tr>
                    <tr>
                      <td class="cls_005">` +
		obj.customerPostcode.value +
		` ` +
		obj.customerAddress3.value +
		`</td>
                    </tr>
                    <tr>
                      <td class="cls_004">&nbsp;</td>
                ...
                <td>
                  <table>
                    ...
                    <tr>
                      <td class="cls_005">Naam: ` +
		obj.testedWith.value +
		`</td>
                    </tr>
                    <tr>
                      <td class="cls_005">` +
		...
		`</td>
		    ...
		    <tr>
                    ...
                    <tr>
                      <td class="cls_005"><span class="cls_004">Uitkomst test:</span> ` +
		obj.testStatus.value +
		`</td>
                    </tr>
                    <tr>
                      <td class="cls_005"><span class="cls_004">Gekeurd op:</span> ` +
		obj.testDate.value +
		`, ` +
		obj.testTime.value +
		`</td>
                    ...
                    <tr>
                      <td class="cls_005"><span class="cls_004">Geldig tot:</span> : ` +
        ...
        <tr>
          <td>
            <table style="width: 100%; padding-left: 30px;">
              ...
              <tr>
                <td class="cls_008">Artikelnummer: ` +
		obj.articleNumber.value +
		`</td>
                <td></td>
              </tr>
            </table>
        ...
        <tr>
          <td>
            <table style="width: 100%; padding-left: 30px;">
              <tr>
                <td class="cls_004">` +
		obj.articleDescription.value +
		` ` +
		obj.articleSerialnumber.value +
		`</td>
                <td></td>
              </tr>
              <tr>
		...
		`</td>
              ...
              <tr>
                <td class="cls_004">&nbsp;</td>
                <td class="cls_005">` +
		obj.testGroupDescription.value +
		`</td>
              </tr>
              <tr>
                <td class="cls_004">Testgroep spanning</td>
                <td class="cls_005">` +
		obj.testGroupVoltage.value +
		`</td>
              </tr>
              <tr>
                <td class="cls_004">&nbsp;</td>
